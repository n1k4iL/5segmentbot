    ...
    def operation(self):
        ...
        if int(remove_audio):
            for ele in os.listdir("mainTemp"):
                ...
                q =  "ffmpeg -f lavfi -i anullsrc=channel_layout=stereo:sample_rate=44100 -i {} -c:v copy -c:a aac -shortest {}".format(source,dest)
                print(q)
                try:
                    os.system(f"""{q}""")
                except:
            ...
            for x in tempmusicpathfiles:
                ...
                for y in m2:
                    ...
                    try:
                        ...
                        q = "ffmpeg -i \"{}\" -stream_loop -1 -i \"{}\" -c:v copy -filter_complex \"[0:a]aformat=fltp:44100:stereo,apad[0a];[1]aformat=fltp:44100:stereo,volume={}[1a];[0a][1a]amerge[a]\" -map 0:v -map \"[a]\" -ac 2 -shortest -y {}".format(y1, x1, dial,fname)
                        os.system(f"""{q}""")
                        print(q)
                    except:
                        pass
